...
mod tests {
    ...
    fn test_parse_kind_3_with_relay_and_petname() {
        ...
        let tags = vec![
            Tag::parse(vec!["p".to_string(), pubkey.to_string(), relay.to_string(), petname.to_string()]).unwrap(),
        ];
    ...
    fn test_parse_kind_3_with_empty_relay() {
        ...
        let tags = vec![
            Tag::parse(vec!["p".to_string(), pubkey.to_string(), "".to_string(), petname.to_string()]).unwrap(),
        ];
    ...
    fn test_parse_kind_3_mixed_tags() {
        ...
        let tags = vec![
            Tag::parse(vec!["t".to_string(), "hashtag".to_string()]).unwrap(),
            Tag::parse(vec!["p".to_string(), pubkey1.to_string(), "wss://relay1.com".to_string(), "alice".to_string()]).unwrap(),
            Tag::parse(vec!["r".to_string(), "wss://relay.example.com".to_string()]).unwrap(),
            Tag::parse(vec!["p".to_string(), pubkey2.to_string()]).unwrap(),
        ];
