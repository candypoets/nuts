...
impl SignerManagerImpl {
    ...
    pub fn js_sign_event(&self, binary_data: &[u8]) -> Result<()> {
        ...
        let mut event: Event = rmps::from_slice(binary_data)
...
impl WasmSignerManager {
    ...
    #[wasm_bindgen(js_name = hasSigner)]
    ...
    #[wasm_bindgen(js_name = jsNip04Encrypt)]
    ...
    #[wasm_bindgen(js_name = jsNip04Decrypt)]
    ...
    #[wasm_bindgen(js_name = jsNip44Encrypt)]
    ...
    #[wasm_bindgen(js_name = jsNip44Decrypt)]
...
mod tests {
    ...
    fn test_sign_event() {
        ...
        let mut event = event_builder
            .to_event(&Keys::parse(&pubkey).unwrap())
            .unwrap();

        assert!(manager.sign_event(&mut event).is_ok());
    ...
    fn test_no_signer_error() {
        ...
        let mut event = event_builder.to_event(&dummy_keys).unwrap();
